 ...
 */
final class Version20200622022559 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD rastreo VARCHAR(255) DEFAULT NULL, CHANGE seller_id seller_id INT DEFAULT NULL, CHANGE buyer_id buyer_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE shipping_address CHANGE personalization_id personalization_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ticket DROP rastreo, CHANGE seller_id seller_id INT DEFAULT NULL, CHANGE buyer_id buyer_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
