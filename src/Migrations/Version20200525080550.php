 ...
 */
final class Version20200525080550 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_active TINYINT(1) DEFAULT \'1\' NOT NULL, CHANGE roles roles JSON NOT NULL');
